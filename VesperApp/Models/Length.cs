...
namespace VesperApp.Models {
    public class Length {
        ...
        public static implicit operator int(Length x) => (int)(x.Value * 240000 / 1000 /*Program.Project.BPM*/);
        public static implicit operator double(Length x) => x.Value * 240000 / 1000 /*Program.Project.BPM*/;
