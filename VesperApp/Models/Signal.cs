...
namespace VesperApp.Models {
    public class Signal {
        ...
        public int[] Macros {
            get => _macros;
            set => _macros = value?? new int[] {1, 1, 1, 1};
        }
        ...
        public Signal(object origin, object source, byte index = 11, Color color = null, int[] macros = null, int layer = 0, BlendingType blending = BlendingType.Normal, int blendingrange = 200, Stack<List<int>> multiTarget = null) {
            Origin = origin;
            Source = source;
            Index = index;
        ...
        public override string ToString() => $"{((Source == null)? "null" : Source.ToString)} -> {Index} @ {Layer} + {BlendingMode} = {Color}";
    }
