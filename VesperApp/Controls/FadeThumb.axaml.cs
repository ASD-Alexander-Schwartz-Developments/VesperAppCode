...
namespace VesperApp.Controls {
    public partial class FadeThumb: UserControl {
        void InitializeComponent() {
            AvaloniaXamlLoader.Load(this);

            baseThumb = this.Get<Thumb>("Thumb");
        ...
        public /*FadeViewer*/object Owner;
        ...
        public FadeThumb() {
            ...
            menuItems = ((VesperContextMenu)this.Resources["ThumbContextMenu"]).Items.OfType<MenuItem>().ToList();

            baseThumb.AddHandler(InputElement.PointerPressedEvent, MouseDown, RoutingStrategies.Tunnel);
            baseThumb.AddHandler(InputElement.PointerReleasedEvent, MouseUp, RoutingStrategies.Tunnel);
        }
        ...
        void Unloaded(object sender, VisualTreeAttachmentEventArgs e) {
            ...
            baseThumb.RemoveHandler(InputElement.PointerPressedEvent, MouseDown);
            baseThumb.RemoveHandler(InputElement.PointerReleasedEvent, MouseUp);
        }
        ...
        void MouseUp(object sender, PointerReleasedEventArgs e) {
            ...
            if (!NoMenu && MouseButton == PointerUpdateKind.RightButtonReleased) {
                ...
                ((VesperContextMenu)this.Resources["ThumbContextMenu"]).Open(baseThumb);
