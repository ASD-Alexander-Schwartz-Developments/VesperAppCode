...
namespace VesperApp.Controls {
    public partial class DeviceAdd: AddButton {
        ...
        protected override void Click(PointerReleasedEventArgs e) {
            ...
            if (MouseButton == PointerUpdateKind.LeftButtonReleased) ((VesperContextMenu)this.Resources["AddContextMenu"]).Open(Icon);
            else if (MouseButton == PointerUpdateKind.RightButtonReleased) ((VesperContextMenu)this.Resources["DeviceContextMenu"]).Open(Icon);
        }
    }
}
