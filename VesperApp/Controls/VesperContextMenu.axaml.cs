...
namespace VesperApp.Controls {
    public partial class VesperContextMenu: ContextMenu, IStyleable {
        ...
        public delegate void MenuActionWithSenderEventHandler(VesperContextMenu sender, string action);
        public event MenuActionWithSenderEventHandler MenuActionWithSender;

        public VesperContextMenu() {
