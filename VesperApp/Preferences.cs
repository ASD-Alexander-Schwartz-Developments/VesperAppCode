...
namespace VesperApp {
    public static class Preferences {
        ...
        static readonly string FilePath = Path.Combine(Directory.GetCurrentDirectory(), "Apollo.config");
        static readonly string StatsPath = Path.Combine(Directory.GetCurrentDirectory(), "Apollo.stats");
