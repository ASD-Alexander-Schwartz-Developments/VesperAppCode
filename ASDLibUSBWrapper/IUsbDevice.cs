...
namespace ASDLibUSBWrapper
{
    ...
    public interface IUsbDevice : IDisposable
    {
        ...
        /// </summary>
        LibUsbDeviceHandle DeviceHandle { get; }
        ...
        bool IsKernelDriverActive(int InterfaceNumber);
        ...
        /// See section 9.3 USB LibUsbDevice Requests of the Universal Serial Bus Specification Revision 2.0 for more information.
        /// </param>
        /// <returns>
