...
{
    /// <summary>
    /// Initializes a new libusb context. You can access most of libusb's functionality through context. 
    /// Multiple context instances operate in isolation from each other.
    /// </summary>
    /// <seealso 
    public interface IUsbContext : IDisposable
    {
        ...
        /// </para>
        /// </remarks>
        UsbDeviceCollection UsbDevices();
        ...
        /// </returns>
        IUsbDevice FindSingleDevice(UsbDeviceFinder finder);
        ...
        /// If found, the requested device. Otherwise, <see langword="null"/>.
        /// </returns>
        IUsbDevice FindSingleDevice(Func<IUsbDevice, bool> predicate);
        ...
        /// </returns>
        UsbDeviceCollection FindMultipleDevices(UsbDeviceFinder finder);
        ...
        /// A list of devices which match the criteria you've specified.
        /// </returns>
        UsbDeviceCollection FindMultipleDevices(Func<IUsbDevice, bool> predicate);
